...
var paths = cfg.paths;
var releaseName = cfg.paths.release + cfg.applicationVersion;
...
gulp.task('clean-dist-product', function () {
    return del(['./' + releaseName + '.zip', './' + releaseName + '/**']);
});
...
gulp.task('dist-product', ['clean-dist-product'], function () {
    return gulp.src(['**/*', '!' + paths.bower, '!' + paths.bower + '/**', '!' + paths.node, '!' + paths.node + '/**', '!' + paths.dist, '!' + paths.dist + '/**', '!' + paths.distprod, '!' + paths.distprod + '/**', '*'])
        .pipe(gulp.dest('./' + releaseName));
});

gulp.task('zip', ['dist-product'], function () {
    return gulp.src('./' + releaseName + '/**')
        .pipe(zip(releaseName + '.zip'))
        .pipe(gulp.dest('./'));
});

gulp.task('release', ['zip'], function () {
    return del(['./' + releaseName + '/**']);
});